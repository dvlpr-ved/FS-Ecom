  ...
  <div class="productdetail_man_div py-5">
    <div class="container">
      <div class="flexdiv flex f-wrap justify-between">
        <div
          class="detailGallery lg:w-[48%] w-[100%] bg-gray-200"
        ...
        <div class="productcontent lg:w-[50%] w-[100%]">
          <h6 class="pro-title lg:text-4xl text-2xl mb-3">
            Banarasi Blue Saree
          </h6>
          <div class="price">
      ...
      <!-- Releted Products -->
      <div class="reletedProducts pt-4 flex flex-wrap gap-[17px] justify-center">
