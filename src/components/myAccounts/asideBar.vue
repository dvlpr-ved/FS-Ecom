...
<template>
  <aside class="accountsAsideBar lg:w-[20%] w-[100%]">
    <div class="commonbox userAvtarInfo p-3 bg-white shadow-sm rounded-sm mb-3">
      <div class="flexdiv flex gap-3">
        <img class="w-[50px] h-[50px] rounded-full" src="~assets/images/users/user.png" />
        <div class="userInfo">
          <small class="welcMs block">welcome</small>
          <strong class="userName block text-xl">User Name</strong>
        </div>
      </div>
    </div>
    <div class="commonbox userAvtarInfo p-3 bg-white shadow-sm rounded-sm mb-3">
      ...
      <nuxt-link
        ...
        ><i class="pi pi-arrow-right"></i> My Aorders
      </nuxt-link>

      <nuxt-link to="myaccounts/whitelist" class="text-[15px] block capitalize hover:text-pink-500"
    ...
    <div class="commonbox userAvtarInfo p-3 bg-white shadow-sm rounded-sm">
      <div class="headingLg text-xl cursor-pointer text-center"><i class="pi pi-sign-out text-xl"></i> Log Out</div>
    </div>
  </aside>
</template>
<style lang="scss">
